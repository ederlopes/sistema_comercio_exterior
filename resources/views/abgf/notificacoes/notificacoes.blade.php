        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Novo(s) Cadastro(s)</h3>
                ...
                @if(Auth::user()->ID_PERFIL == 1)
                 @forelse ($notificacaoNovoExportador as $NotificNExp)
                          ...
                          <tr>
                            ...
                            <td class="mailbox-star"><a href="{{ route('abgf.exportador.validacao',[$NotificNExp->ID_USUARIO]) }}"><i class="fa fa-star text-yellow"></i></a></td>
                            ...
                            <td class="mailbox-date">{{ date('d/m/Y', strtotime($NotificNExp->DATA_NOTIFICACAO)) }}</td>
                          </tr>
