        ...
        <div class="panel-body">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="input-group date datetimepicker4">
                        <input type="text" id="dt_desembolso" class="form-control input-sm datetimepicker4" name="dt_desembolso" id="dt_desembolso" value="">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="vl_desembolso" id="vl_desembolso" value="{{formatar_valor_sem_moeda($mpmeProposta->VL_PROPOSTA)}}" class="form-control money" readonly="readonly">
                </div>
            </div>
