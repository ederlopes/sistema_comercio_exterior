<div style="background:#F5F5F5; font-size:13px; font-family:\'Trebuchet MS\', Arial, Helvetica, sans-serif; padding:10px">
	...
	<div style="background:#FFF;border:1px solid #005071; padding:15px">
		...
		<p>
			@component('mail::button', ['url' => config('app.url').'download/'.$operacao->ID_MPME_ARQUIVO_TERMOS_USO])
				Termos e Condições de uso
			@endcomponent
			<a href="{{Route('notificacoes.arquivo.download', ['ID_MPME_ARQUIVO' => $operacao->ID_MPME_ARQUIVO_TERMOS_USO])}}" class="btn btn-primary">Termos e Condições de uso</a> |
