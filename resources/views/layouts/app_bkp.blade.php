...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini" style="font-size: 14px;"><b>M</b>PME</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SGP</b> MPME</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> 5 novos cadastros
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-warning text-yellow"></i> Ocorreu um problema com acesso a operações de um determinado usuário
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-red"></i> 5 novos cadastros recusados
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-shopping-cart text-green"></i> 25 novas operações
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-user text-red"></i> Você atualizou seu perfil
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li><!-- Task item -->
                    <a href="#">
                      <h3>
                        Analisar retorno das operações
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Ultimo login: {{ date('d/m/Y H:i', strtotime(Auth::user()->last_login_time)) }} </small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="#">Área Operacional</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="#">Exp. Analisados</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="#">Imp. Analisados</a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/notificacoes"><i class="fa fa-circle-o"></i> Notificações</a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Cadastros Liberados</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Cadastros Recusados</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> CGC Emitidos</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Tempo de Análise</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; {{date('d-m-Y')}} <a href="https://mpme.abgf.gov.br">SGP MPME</a>.</strong> Todos os direitos reservados.
  </footer>
